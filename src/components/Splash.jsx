  ...
  return (
    <div className="relative flex flex-col items-center justify-between min-h-screen w-full max-w-md mx-auto bg-[#eff6ff] dark:bg-[#05070d] overflow-hidden pb-10 transition-colors">
      ...
      <div className="flex flex-col items-center z-10 px-8 text-center mt-10">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-[15px] font-medium max-w-[240px] leading-relaxed">
      ...
      <div className="flex-1 flex flex-col justify-end w-full px-6 z-10">
        <Link to="/login" className="w-full">
          <button className="w-full bg-[#954A29] hover:bg-[#7a3b1f] dark:bg-gradient-to-r dark:from-cyan-400 dark:to-blue-500 dark:hover:opacity-90 text-white font-semibold py-4 rounded-full flex items-center justify-center gap-2 transition-colors shadow-md">
            Mulai
