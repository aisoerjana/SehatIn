  ...
  return (
    <div className="flex flex-col h-screen bg-[#eff6ff] dark:bg-[#05070d] transition-colors">
      ...
      <div className="flex-1 p-5 overflow-y-auto pb-8">
        ...
        {error && (
          <div className="mt-8 flex items-start gap-2 text-xs text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-500/10 rounded-2xl px-5 py-4">
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {rekomendasi.rekomendasi_bahan.map((item, index) => {
                    ...
                    return (
                      <div key={index} className="bg-white dark:bg-[#0b0f17] p-4 rounded-2xl border border-gray-100 dark:border-white/10 shadow-sm transition-colors">
