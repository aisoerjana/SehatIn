...
export default function Register() {
  ...
  return (
    <div className="page-enter flex flex-col h-dvh w-full max-w-md mx-auto bg-[#eff6ff] dark:bg-[#05070d] px-4 pt-6 pb-2 overflow-hidden transition-colors">
      <div className="flex-1 overflow-y-auto">
        {/* Card Container */}
        <div className="page-enter-up bg-white dark:bg-[#0b0f17] rounded-3xl shadow-sm border border-gray-100 dark:border-white/10 p-6 flex flex-col transition-colors">
          ...
          <form className="flex flex-col gap-4">
            ...
            <button
              ...
              className={`page-enter-up w-full text-white font-semibold py-3.5 rounded-xl transition-colors mt-2 flex items-center justify-center gap-2 shadow-sm ${
                isFormValid && !loading
      ...
      {/* Footer / Login Link */}
      <div className="page-enter pt-4 pb-4 text-center shrink-0" style={{ animationDelay: '350ms' }}>
