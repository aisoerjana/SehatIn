...
import { prosesAsesmen } from './asesmen'
import { ambilRiwayatUntukGrafik } from './riwayat'
import { exportHasilKePDF } from './exportPdf'
      ...
      <div className="min-h-screen bg-slate-100 p-4 flex items-center justify-center">
        <div className="max-w-sm w-full">
          <button onClick={() => navigate('/')}
            className="text-xs text-gray-500 underline mb-4 block">&larr; Kembali</button>
      ...
      <div className="max-w-sm mx-auto">
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => { supabase.auth.signOut(); setView('form'); setResult(null); navigate('/') }}
        ...
        <button onClick={() => navigate('/dashboard')}
          className="w-full bg-gray-200 text-gray-700 py-3 rounded-lg text-sm font-medium mt-2">
